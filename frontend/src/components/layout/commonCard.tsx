...
// export const CorrectButton = styled(FeedbackButton)`
//     border-color: #3eb38c;
//     background-color: #141c3a;
//     /* border: 1px solid #2d5dcc; */
//     /* background-color: #141c3a; */
...
// export const IncorrectButton = styled(FeedbackButton)`
//     border-color: #e53935;
...
// export const UnselectedButton = styled(FeedbackButton)`
//     border-color: #2d5dcc;
//     background-color: #141c3a;
// `;
...
// 					</CodeBlock>
// 					<Description>
// 						<p>text with <code>sample code </code> nested. In order to implement a stack using a node class, we have to store a node that is currently referencing the top of the stack and update it during the push and pop operations.</p>
// 					</Description>
// 					<ButtonGroup>
// 						<MinusButton />
// 						<PlusButton />
...
export const Heading = styled.div`
  font-weight: 700;
  font-size: 1.5rem;
  font-family: Apercu, -apple-system, BlinkMacSystemFont,
...
export const MainFeed: React.FC<SnippetProps> = ({
  snippets,
}) => {
  const label = 'what';
  return (
...
//     {/* <MainSideAccordion> */}
//       <SideNav>
//         <a>text text text text text text text text text text text text gewwgeweggegegwe</a>
//         <a><p>text text text text text text text text text text text text text text text text text text text text text text text text</p></a>
//       </SideNav>
//     {/* </MainSideAccordion> */}
//   {/* </MainSide> */}
